    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/api/users/**","/api/v1/roles" ).hasRole("ADMIN")
                       // .requestMatchers("/api/users", "/api/v1/{username}", "/api/v1/{username}" , "/api/v1/{username}/updateRole","/api/v1/roles" ,  "/api/v1/register", "/api/v1/change-password").hasRole("ADMIN")
